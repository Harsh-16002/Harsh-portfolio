...
const ServiceCard = ({ index, title, icon }) => (
  <Tilt tiltMaxAngleX={20} tiltMaxAngleY={20} scale={1.05} className="xs:w-[250px] w-full">
    <motion.div
  ...
  return (
    <>
      ...
      >
        ...
        specializing in frameworks like React and Node.js. I'm a quick learner and
